  ...
  requestDidStart(requestContext) {
    ...
    return {
      didEncounterErrors(requestContext) {
        console.log(requestContext.errors[0]);
      },
      ...
      executionDidStart(context) {
        ...
        // console.log(
        //   "ApolloIdempotent::executionDidStart document",
        //   context.document.definitions
        // );
        // console.log(
        //   "ApolloIdempotent::executionDidStart operationName",
        //   context.operationName
        // );
        // console.log(
        //   "ApolloIdempotent::executionDidStart operation",
        //   context.operation
        // );
      },
