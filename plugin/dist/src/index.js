...
var obs = new perf_hooks_1.PerformanceObserver(function (items) {
    var perfInfo = items.getEntries()[0];
    var logInfo = {
        perfInfo: perfInfo,
        additionInfo: additionInfo,
    };
    node_fetch_1.default(logServerInfo.enginUrl, {
        method: "POST",
        headers: {
...
exports.default = (function (config) {
    ...
    return {
        requestDidStart: function (service) {
            var isIntrospectionRequest = service.request.operationName === "IntrospectionQuery";
            if (isIntrospectionRequest) {
                return;
            }
            startMark = generate_id_1.default("xxxx-xxxx-xxxx");
            perf_hooks_1.performance.mark(startMark);
            endMark = generate_id_1.default("xxxx-xxxx-xxxx");
